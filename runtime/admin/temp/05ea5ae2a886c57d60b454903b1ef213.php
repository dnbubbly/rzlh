<?php /*a:2:{s:61:"E:\wamp64\www\rlzy\app\admin\view\step\flowdetail\reback.html";i:1644809795;s:53:"E:\wamp64\www\rlzy\app\admin\view\layout\default.html";i:1638342384;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
	...
	<form id="app-form" class="layui-form layuimini-form layui-form-pane">
	  	<div class="layui-field-box">
		    ...
		    <div class="layui-form-item">
		        ...
		        <div class="layui-input-block">
		            <input type="text" name="date" data-date="" readonly="true" data-date-type="datetime" class="layui-input"  placeholder="请输入审批时间" value="<?php echo date('Y-m-d'); ?>">
		        </div>
		    </div> 
	  	</div>
		<div class="layui-field-box">
