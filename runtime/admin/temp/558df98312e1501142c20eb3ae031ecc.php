<?php /*a:2:{s:54:"E:\wamp64\www\rlzy\app\admin\view\system\step\add.html";i:1638761253;s:53:"E:\wamp64\www\rlzy\app\admin\view\layout\default.html";i:1638342384;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form id="app-form" class="layui-form layuimini-form layui-form-pane">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="number" class="layui-input"  placeholder="请输入流程编号" value="">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">流程名称</label>
            <div class="layui-input-block">
                <input type="text" name="title" class="layui-input"  placeholder="请输入流程名称" value="">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">应用模块</label>
            <div class="layui-input-block">
                <input type="text" id="model" name="model" class="layui-input"  placeholder="请输入应用模块" value="">
            </div>
        </div>
