<?php /*a:2:{s:57:"E:\wamp64\www\rzlh\app\admin\view\customer\score\add.html";i:1645496023;s:53:"E:\wamp64\www\rzlh\app\admin\view\layout\default.html";i:1645080665;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form id="app-form" class="layui-form layuimini-form layui-form-pane">
            ...
            <div class="layui-col-md4">
		        <div class="layui-form-item">
		            ...
		            <div class="layui-input-block inputSelect layui-form">
		            	<select name="cus_id" lay-verify="required" lay-search="" data-select="<?php echo url('customer.info/indexscore'); ?>" data-fields="id,name" data-value="">
		            	</select>
		            </div>
		        </div>
		    </div>
		    <div class="layui-col-md4">
		        <div class="layui-form-item">
		            ...
		            <div class="layui-input-block">
		                <input type="text" name="date" data-date="" data-date-type="date" class="layui-input" lay-verify="required" placeholder="请输入评分日期" value="">
		            </div>
		        </div>
		    </div>
		</div>
			...
			<tbody>
				<tr>
					...
					<td align="center" rowspan="8">
						<input id="grade1" name="grade1" type="text" style="WIDTH: 70px;height: 30px" runat="server" oninput="CountMoney();" />
					</td>
				...
				<tr>
					...
					<td align="center" rowspan="6">
						<input id="grade2" name="grade2" type="text" style="WIDTH: 70px;height: 30px" runat="server" oninput="CountMoney();" />
					</td>
				...
				<tr>
					...
					<td align="center" rowspan="5">
						<input id="grade3" name="grade3" type="text" style="WIDTH: 70px;height: 30px" runat="server" oninput="CountMoney();" />
					</td>
					<td align="center" rowspan="5">&nbsp;</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="center" rowspan="3">
						<input id="grade4" name="grade4" type="text" style="WIDTH: 70px;height: 30px" runat="server" oninput="CountMoney();" />
					</td>
					<td align="center" rowspan="3">&nbsp;</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="center">
						<input id="grade5" name="grade5" type="text" style="WIDTH: 70px;height: 30px" runat="server" oninput="CountMoney();" />
					</td>
					<td align="center">&nbsp;</td>
				</tr>
				<tr>
					...
					<td align="center">
						<input id="grade6" name="grade6" type="text" style="WIDTH: 70px;height: 30px" runat="server" oninput="CountMoney();" />
					</td>
					<td align="center">&nbsp;</td>
				</tr>
				<tr>
					...
					<td align="center" rowspan="2">
						<input id="grade7" name="grade7" type="text" style="WIDTH: 70px;height: 30px" runat="server" oninput="CountMoney();" />
					</td>
				...
				<tr>
					...
					<td align="center" rowspan="3">
						<input id="grade8" name="grade8" type="text" style="WIDTH: 70px;height: 30px" runat="server" oninput="CountMoney();" />
					</td>
					<td align="center" rowspan="3">&nbsp;</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="center" rowspan="2">&nbsp;</td>
					<td align="center" rowspan="2">
						<input id="grade9" name="grade9" type="text" style="WIDTH: 70px;height: 30px" runat="server" oninput="CountMoney();" />
					</td>
					<td align="center" rowspan="2">&nbsp;</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="center" rowspan="3">&nbsp;</td>
					<td align="center" rowspan="3">
						<input id="grade10" name="grade10" type="text" style="WIDTH: 70px;height: 30px" runat="server" oninput="CountMoney();" />
					</td>
					<td align="center" rowspan="3">&nbsp;</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="center" rowspan="2">&nbsp;</td>
					<td align="center" rowspan="2">
						<input id="grade11" name="grade11" type="text" style="width: 70px;height: 30px" runat="server" oninput="CountMoney();" />
					</td>
					<td align="center" rowspan="2">&nbsp;</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="center" rowspan="2">
						<input id="total" name="total" readonly="true" type="text" style="width: 70px;height: 30px" runat="server" oninput="CountMoney();" />
					</td>
				</tr>
			</tbody>
		</table>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block layuimini-upload">
                <input name="file1" class="layui-input layui-col-xs6" lay-verify="required"  placeholder="请上传资信审查" value="" style="width: calc(100% - 85px);">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block layuimini-upload">
                <input name="file2" class="layui-input layui-col-xs6" lay-verify="required"  placeholder="请上传尽职调查" value="" style="width: calc(100% - 85px);">
                <div class="layuimini-upload-btn">
