<?php /*a:2:{s:56:"E:\wamp64\www\rlzy\app\admin\view\system\admin\edit.html";i:1638926020;s:53:"E:\wamp64\www\rlzy\app\admin\view\layout\default.html";i:1638342384;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layuimini-container">
    <form id="app-form" class="layui-form layuimini-form layui-form-pane">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" class="layui-input" lay-verify="required" lay-reqtext="请输入员工姓名" placeholder="请输入员工姓名" value="<?php echo htmlentities((isset($row['name']) && ($row['name'] !== '')?$row['name']:'')); ?>">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="checkbox" name="is_leader" <?php if(($row['is_leader']==1)): ?> checked="" <?php endif; ?> lay-skin="switch" lay-text="ON|OFF" value="<?php echo htmlentities($row['is_leader']); ?>">
            </div>
        </div>
		...
		<div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="number" class="layui-input" lay-verify="required" lay-reqtext="请输入员工工号" placeholder="请输入员工工号" value="<?php echo htmlentities((isset($row['number']) && ($row['number'] !== '')?$row['number']:'')); ?>">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="age" class="layui-input" placeholder="请输入员工年龄" value="<?php echo htmlentities((isset($row['age']) && ($row['age'] !== '')?$row['age']:'')); ?>">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="job" class="layui-input" lay-verify="required" lay-reqtext="请输入职位" placeholder="请输入职位" value="<?php echo htmlentities((isset($row['job']) && ($row['job'] !== '')?$row['job']:'')); ?>">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="phone" class="layui-input" lay-reqtext="请输入用户手机" placeholder="请输入用户手机" value="<?php echo htmlentities((isset($row['phone']) && ($row['phone'] !== '')?$row['phone']:'')); ?>">
            </div>
        </div>
