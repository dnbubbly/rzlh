<?php /*a:2:{s:66:"E:\wamp64\www\rzlh\app\admin\view\contract\info\qualitydetail.html";i:1645522051;s:53:"E:\wamp64\www\rzlh\app\admin\view\layout\default.html";i:1645080665;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    			...
    			<div v-if="data" class="layui-tab-item <?php if($k==0): ?>layui-show<?php endif; ?>">
			        ...
			        <div class="layui-form-item">
			        	<div class="layui-col-lg3 layui-col-md3 layui-col-sm3">
							<span class="layui-form-label"><?php echo htmlentities($v['name']); ?></span>
								<div class="layui-input-block">
									<select name="qz[<?php echo htmlentities($v['name']); ?>][qz1]" disabled lay-search="" v-model="data.<?php echo htmlentities($v['name']); ?>.qz1">
										<option value=""></option>
						...
						<div class="layui-col-lg3 layui-col-md3 layui-col-sm3" style="left: -2px;">
							...
							<div class="layui-input-block">
								<input name="qz[<?php echo htmlentities($v['name']); ?>][qz2]" readonly="true" type="text" class="layui-input" v-model="data.<?php echo htmlentities($v['name']); ?>.qz2">
							</div>					
						</div>
					</div>
					<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
    				...
    				<div class="layui-form-item" v-for="(value, key) in data.<?php echo htmlentities($v['name']); ?>.qz">
    					<div class="layui-col-space15 qline">
							<div class="layui-col-lg2 layui-col-md2 layui-col-sm2">
					    		<div class="layui-col-lg6 layui-col-md6 layui-col-sm6"><input name="qz[<?php echo htmlentities($v['name']); ?>][qz3][]" readonly="true" type="text" class="layui-input" v-model="value[0]"></div>
								<div class="layui-col-lg6 layui-col-md6 layui-col-sm6" style="left: -1px">
									<select name="qz[<?php echo htmlentities($v['name']); ?>][qz4][]" disabled lay-verify="required" lay-search="" v-model="value[1]">
										<option value=""></option>
							...
							<div class="layui-col-lg2 layui-col-md2 layui-col-sm2">
					        	<div class="layui-col-lg6 layui-col-md6 layui-col-sm6">
									<select name="qz[<?php echo htmlentities($v['name']); ?>][qz5][]" disabled lay-verify="required" lay-search="" v-model="value[2]">
										<option value=""></option>
										<option value="＜">＜</option>
										<option value="≤" selected = "selected" >≤</option>
									</select>
	                        	</div>
	                        	<div class="layui-col-lg6 layui-col-md6 layui-col-sm6"><input name="qz[<?php echo htmlentities($v['name']); ?>][qz6][]" readonly="true" type="text" class="layui-input" v-model="value[3]"></div>
							</div>
							<div class="layui-col-lg2 layui-col-md2 layui-col-sm2">
								<div class="layui-col-lg6 layui-col-md6 layui-col-sm6">
									<select name="qz[<?php echo htmlentities($v['name']); ?>][qz7][]" disabled lay-verify="required" lay-search="" v-model="value[4]">
										<option value=""></option>
										<option value="每升高" selected = "selected" >每升高</option>
										<option value="每降低">每降低</option>
									</select>
	                        	</div>
	                        	<div class="layui-col-lg6 layui-col-md6 layui-col-sm6"><input name="qz[<?php echo htmlentities($v['name']); ?>][qz8][]" readonly="true" type="text" class="layui-input" v-model="value[5]"></div>				
							</div>
							<div class="layui-col-lg2 layui-col-md2 layui-col-sm2">
								<div class="layui-col-lg6 layui-col-md6 layui-col-sm6">
									<select name="qz[<?php echo htmlentities($v['name']); ?>][qz9][]" disabled lay-verify="required" lay-search="" v-model="value[6]">
										<option value=""></option>
										<option value="加价" selected = "selected" >加价</option>
										<option value="减价">减价</option>
									</select>
	                        	</div>
	                        	<div class="layui-col-lg6 layui-col-md6 layui-col-sm6"><input name="qz[<?php echo htmlentities($v['name']); ?>][qz10][]" readonly="true" type="text" class="layui-input" v-model="value[7]"></div>					
							</div>
			    		</div>
					</div>
    			</div>
    			<div v-else class="layui-tab-item <?php if($k==0): ?>layui-show<?php endif; ?>">
			        ...
			        <div class="layui-form-item">
			        	<div class="layui-col-lg3 layui-col-md3 layui-col-sm3">
							<span class="layui-form-label"><?php echo htmlentities($v['name']); ?></span>
								<div class="layui-input-block">
									<select name="qz[<?php echo htmlentities($v['name']); ?>][qz1]" disabled lay-search="">
										<option value=""></option>
										<?php foreach($v['unit'] as $u): ?>
										<option  value="<?php echo htmlentities($u['unit']); ?>"><?php echo htmlentities($u['unit']); ?></option>
										<?php endforeach; ?>
