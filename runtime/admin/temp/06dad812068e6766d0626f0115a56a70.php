<?php /*a:2:{s:58:"E:\wamp64\www\rzlh\app\admin\view\customer\score\edit.html";i:1645495863;s:53:"E:\wamp64\www\rzlh\app\admin\view\layout\default.html";i:1645080665;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="layui-col-md4">
		        <div class="layui-form-item">
		            ...
		            <div class="layui-input-block inputSelect layui-form">
		            	<select name="cus_id" lay-verify="required" lay-search="" data-select="<?php echo url('customer.info/indexscore'); ?>" data-fields="id,name" data-value="<?php echo htmlentities((isset($row['cus_id']) && ($row['cus_id'] !== '')?$row['cus_id']:'')); ?>">
		            	</select>
		            </div>
		        </div>
		    </div>
