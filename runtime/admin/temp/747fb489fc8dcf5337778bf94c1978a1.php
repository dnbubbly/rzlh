<?php /*a:2:{s:59:"E:\wamp64\www\rzlh\app\admin\view\contract\quality\add.html";i:1645175589;s:53:"E:\wamp64\www\rzlh\app\admin\view\layout\default.html";i:1645080665;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form id="app-form" class="layui-form layuimini-form layui-form-pane">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" class="layui-input" lay-verify="required" placeholder="请输入指标名称" value="">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">指标单位</label>
            <div class="layui-input-block">
                <input type="text" name="unit" class="layui-input" lay-verify="required" placeholder="请输入指标单位" value="">
            </div>
        </div>
        <div class="layui-form-item">
