    ...
    <form id="app-form" class="layui-form layuimini-form layui-form-pane">
        ...
        <div class="layui-form-item">
	        ...
	        <div class="layui-inline">
	            ...
	            <div class="layui-input-inline">
	            	<select name="address" lay-verify="required" lay-search="" data-select="<?php echo url('contract.address/index'); ?>" data-fields="id,name" data-value="<?php echo htmlentities((isset($row['address']) && ($row['address'] !== '')?$row['address']:'')); ?>">
		        	</select>
	            </div>
	        </div>
	        <div class="layui-inline">
	            ...
	            <div class="layui-input-inline">
	                <input type="text" name="date" data-date="" data-date-type="date" autocomplete="off" class="layui-input" lay-verify="required" placeholder="请输入起草日期" value="<?php echo htmlentities((isset($row['date']) && ($row['date'] !== '')?$row['date']:'')); ?>">
	            </div>
	        </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-inline">
	            ...
	            <div class="layui-input-inline">
	                <input type="text" name="receivingname" class="layui-input" lay-verify="required" placeholder="请输入收货单位" value="<?php echo htmlentities((isset($row['customerInfoReceiving']['name']) && ($row['customerInfoReceiving']['name'] !== '')?$row['customerInfoReceiving']['name']:'')); ?>" id="receivingname" ts-selected="<?php echo htmlentities($row['receiving']); ?>">
	        ...
	        <div class="layui-inline">
	            ...
	            <div class="layui-input-inline">
	                <input type="text" name="settlementname" class="layui-input" lay-verify="required" placeholder="请输入结算单位" value="<?php echo htmlentities((isset($row['customerInfoSettlement']['name']) && ($row['customerInfoSettlement']['name'] !== '')?$row['customerInfoSettlement']['name']:'')); ?>" id="settlementname" ts-selected="<?php echo htmlentities($row['settlement']); ?>">
        ...
        <div class="layui-form-item">
				<table class="layui-table" style="width:800px;margin: 0;table-layout: fixed;">
		    		...
		    		<tbody id="td">
		    			...
		    			<?php endforeach; ?>
		    			<tr>
		    				<td style="text-align: center;"><?php echo count($row->detail)+1; ?></td>
		    				<td><select name="coal[<?php echo count($row->detail)+1; ?>][type]" lay-filter="road" lay-search="" data-select="<?php echo url('contract.coaltype/index'); ?>" data-fields="id,name" data-value=""></select></td>
		    				<td><input class="layui-input" name="coal[<?php echo count($row->detail)+1; ?>][num]" value=""></td>
		    				<td><input class="layui-input" name="coal[<?php echo count($row->detail)+1; ?>][price]" value=""></td>
		    				<td style="text-align: center;"><i class="layui-icon addt">&#xe61f;</i></td>
		    				<td style="text-align: center;"><i data-index="<?php echo count($row->detail)+1; ?>" class="layui-icon qualityt">&#xe659;</i><input type="hidden" name="coal[<?php echo count($row->detail)+1; ?>][json]" value=""></td>
		    			</tr>
		      		</tbody>
		      	</table>
		    </div>
        ...
        <div class="layui-form-item">
        	<div class="layui-inline">
	            ...
	            <div class="layui-input-inline">
	                <input type="text" name="startdate" data-date="" data-date-type="date" autocomplete="off" class="layui-input" lay-verify="required" placeholder="请输入执行期起" value="<?php echo htmlentities((isset($row['startdate']) && ($row['startdate'] !== '')?$row['startdate']:'')); ?>">
	            </div>
	        </div>
	        <div class="layui-inline">
	            <label class="layui-form-label">执行期止</label>
	            <div class="layui-input-inline">
	                <input type="text" name="enddate" data-date="" data-date-type="date" autocomplete="off" class="layui-input" lay-verify="required" placeholder="请输入执行期止" value="<?php echo htmlentities((isset($row['enddate']) && ($row['enddate'] !== '')?$row['enddate']:'')); ?>">
	            </div>
	        </div>
        </div>
        <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
        ...
        <div class="layui-form-item">
        	<div class="layui-inline">
	            ...
	            <div class="layui-input-inline">
	            	<select name="road" lay-verify="required" lay-filter="road" lay-search="" data-select="<?php echo url('contract.ship/index'); ?>" data-fields="id,name" data-value="<?php echo htmlentities((isset($row['road']) && ($row['road'] !== '')?$row['road']:'')); ?>">
		        	</select>
	            </div>
	        </div>
	        <div class="layui-inline" id="rail1" <?php if($row['road']!=2): ?> style="display: none;" <?php endif; ?>>
	            ...
	            <div class="layui-input-inline">
	            	<select name="rstart_station" lay-verify="required" lay-search="" data-select="<?php echo url('contract.railwaysite/index'); ?>" data-fields="id,name" data-value="<?php echo htmlentities((isset($row['start_station']) && ($row['start_station'] !== '')?$row['start_station']:'')); ?>">
		        	</select>
	            </div>
	        </div>
	        <div class="layui-inline" id="rail2" <?php if($row['road']!=2): ?> style="display: none;" <?php endif; ?>>
	            ...
	            <div class="layui-input-inline">
	            	<select name="rend_station" lay-verify="required" lay-search="" data-select="<?php echo url('contract.railwaysite/index'); ?>" data-fields="id,name" data-value="<?php echo htmlentities((isset($row['end_station']) && ($row['end_station'] !== '')?$row['end_station']:'')); ?>">
		        	</select>
	            </div>
	        </div>
	        <div class="layui-inline" id="hight1" <?php if($row['road']!=1): ?> style="display: none;" <?php endif; ?>>
	            ...
	            <div class="layui-input-inline">
	            	<select name="hstart_station" lay-verify="" lay-search="" data-select="<?php echo url('contract.highwaysite/index'); ?>" data-fields="id,name" data-value="<?php echo htmlentities((isset($row['start_station']) && ($row['start_station'] !== '')?$row['start_station']:'')); ?>">
		        	</select>
	            </div>
	        </div>
	        <div class="layui-inline" id="hight2" <?php if($row['road']!=1): ?> style="display: none;" <?php endif; ?>>
	            ...
	            <div class="layui-input-inline">
	            	<select name="hend_station" lay-verify="" lay-search="" data-select="<?php echo url('contract.highwaysite/index'); ?>" data-fields="id,name" data-value="<?php echo htmlentities((isset($row['end_station']) && ($row['end_station'] !== '')?$row['end_station']:'')); ?>">
		        	</select>
	            </div>
	        </div>
        </div>
        <div class="layui-form-item">
        	<div class="layui-inline">
	            ...
	            <div class="layui-input-inline">
	            	<select name="delivery" lay-verify="required" lay-search="" data-select="<?php echo url('contract.delivery/index'); ?>" data-fields="id,name" data-value="<?php echo htmlentities((isset($row['delivery']) && ($row['delivery'] !== '')?$row['delivery']:'')); ?>">
		        	</select>
	            </div>
	        </div>
	        <div class="layui-inline">
	            ...
	            <div class="layui-input-inline">
	            	<select name="delivery_address" lay-verify="required" lay-search="" data-select="<?php echo url('contract.address/index'); ?>" data-fields="id,name" data-value="<?php echo htmlentities((isset($row['delivery_address']) && ($row['delivery_address'] !== '')?$row['delivery_address']:'')); ?>">
		        	</select>
	            </div>
	        </div>
        </div>
        ...
        <div class="layui-form-item">
	        ...
	        <div class="layui-inline">
	        	<input type="text" name="markupnum" class="layui-input" placeholder="请输入承兑加价数量" value="<?php echo htmlentities((isset($row['markupnum']) && ($row['markupnum'] !== '')?$row['markupnum']:'')); ?>">
	        </div>
	    </div>
        <div class="layui-form-item">
            <div class="layui-inline">
	            ...
	            <div class="layui-input-block">
	                <input type="text" name="advance" class="layui-input" lay-verify="required" placeholder="请输入预付款比例" value="<?php echo htmlentities((isset($row['advance']) && ($row['advance'] !== '')?$row['advance']:'')); ?>">
	            </div>
	        </div>
	        <div class="layui-inline">
	        	<label class="layui-form-label">预付款比例说明</label>
	            <div class="layui-input-block">
	                <input type="text" name="advance_remark" class="layui-input"  placeholder="请输入预付款比例说明" value="<?php echo htmlentities((isset($row['advance_remark']) && ($row['advance_remark'] !== '')?$row['advance_remark']:'')); ?>">
	            </div>
	        </div>
	        <div class="layui-inline">
        ...
        <div class="layui-form-item">
        	<textarea name="law" rows="20" class="layui-textarea editor" placeholder="请输入底部内容"><?php echo html_entity_decode($row['law']); ?></textarea>
        </div>
        <div class="layui-form-item layui-form-text">
            <label class="layui-form-label">备注</label>
            <div class="layui-input-block">
                <textarea name="remark" class="layui-textarea"  placeholder="请输入备注"><?php echo htmlentities((isset($row['remark']) && ($row['remark'] !== '')?$row['remark']:'')); ?></textarea>
            </div>
        </div>
        <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
              <legend>七、附件</legend>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block layuimini-upload">
                <input name="confile" class="layui-input layui-col-xs6" lay-verify="required"  placeholder="请上传谈判纪要" value="<?php echo htmlentities((isset($row['confile']) && ($row['confile'] !== '')?$row['confile']:'')); ?>" style="width: calc(100% - 85px);">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block layuimini-upload">
                <input name="elefile" class="layui-input layui-col-xs6" lay-verify="required"  placeholder="请上传谈判纪要" value="<?php echo htmlentities((isset($row['elefile']) && ($row['elefile'] !== '')?$row['elefile']:'')); ?>" style="width: calc(100% - 85px);">
                <div class="layuimini-upload-btn">
