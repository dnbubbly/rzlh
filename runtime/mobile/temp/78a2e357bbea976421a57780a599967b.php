		...
		<form id="app-form" class="layui-form layuimini-form">
			...
			<div class="layui-form-item">
	            ...
	            <div class="layui-input-block">
	                <input type="text" name="plan" placeholder="请上传铁路货运单" class="layui-input"  value="">
	            </div>
	        </div>
	        <div class="layui-form-item">
	        ...
	        <div class="layui-form-item">
	            ...
	            <div class="layui-input-block">
	                <input type="text" name="setdate" autocomplete="off" class="layui-input" data-year="<?php echo date('Y'); ?>" data-month="<?php echo date('m'); ?>" data-day="<?php echo date('d'); ?>" id="ScCityOwned" placeholder="" value="">
	            </div>
	        </div>
			<div class="layui-form-item">
	            <label class="layui-form-label required">装车日期</label>
	            <div class="layui-input-block">
	                <input type="text" name="loaddate" autocomplete="off" class="layui-input" data-year="<?php echo date('Y'); ?>" data-month="<?php echo date('m'); ?>" data-day="<?php echo date('d'); ?>" id="dateSelectorOne" placeholder="" value="<?php echo date('Y-m-d'); ?>">
	            </div>
	        </div>
	        <div class="layui-form-item">
	            <label class="layui-form-label required">发站</label>
	            <div class="layui-input-block">
	                <input type="text" name="start_station" class="layui-input" placeholder="请上传铁路货运单" value="">
	            </div>
	        </div>
	        <div class="layui-form-item">
	            <label class="layui-form-label required">到站</label>
	            <div class="layui-input-block">
	                <input type="text" name="end_station" class="layui-input" placeholder="请上传铁路货运单" value="">
	            </div>
	        </div>
	        <div class="layui-form-item">
	            <label class="layui-form-label required">收货单位</label>
	            <div class="layui-input-block">
	                <input type="text" name="cusname" class="layui-input" placeholder="请上传铁路货运单" value="">
	            </div>
	        </div>
	        <div class="layui-form-item">
	            <label class="layui-form-label required">品种</label>
	            <div class="layui-input-block">
	                <input type="text" name="coaltype" class="layui-input" placeholder="请上传铁路货运单" value="">
	            </div>
	        </div>
	        <div class="layui-form-item">
	        ...
	        <div style="overflow-x: auto;">
				<table class="layui-table" style="width:100%;text-align: center;margin: 0;table-layout: fixed;">
		    		...
		    		<tbody id="td">
		    			<tr>
		    				<td>1</td>
		    				<td><input type="hidden" name="sc_id" value=""><input class="layui-input layui-table-edit" name="sale[0][plan]" value=""></td>
		    				<td><input class="layui-input layui-table-edit" name="sale[0][cartype]" value=""></td>
		    				<td><input class="layui-input layui-table-edit" name="sale[0][carcode]" value=""></td>
		    				<td><input class="layui-input layui-table-edit" oninput="count1(this)" name="sale[0][sweight]" value=""></td>
		    				<td><input class="layui-input layui-table-edit" oninput="count1(this)" name="sale[0][fweight]" value=""></td>
