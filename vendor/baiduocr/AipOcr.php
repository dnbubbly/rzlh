...
class AipOcr extends AipBase
{
    ...
    /**
     * 办公文档识别  general api url
     * @var string
     */
    private $officeUrl = 'https://aip.baidubce.com/rest/2.0/ocr/v1/general';
    /**
    ...
    public function basicAccuratepdf($image, $options = array())
    {
        
        $data = array();
        
        $data['pdf_file'] = base64_encode($image);
     ...
     * @return array
     */
    public function office($image, $options = array())
    {
        ...
        return $this->request($this->officeUrl, $data);
    }
