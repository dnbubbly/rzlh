define(["jquery", "easy-admin", "vue", "axios", "vuex", "ELEMENT", "autocomplete"], function ($, ea, Vue, axios, Vuex, element) {
    ...
    var init = {
        ...
        index_url: 'step.flow/index',
        add_url: 'step.flow/add',
        edit_url: 'step.flow/edit',
        delete_url: 'step.flow/delete',
        export_url: 'step.flow/export',
        flow_url: 'step.flow/flow',
        stepnode_url: 'step.flow/flow',
        flowdetail_url: 'step.flow/flowdetail',
    };
        ...
        index: function () {
            ea.table.render({
                ...
                cols: [[
                    ...
                    {field: 'systemAdmin.username', title: '发起人'},
                    {field: 'status', title: '状态', width: 95, search: 'select', selectList: {0: '审核中', 1: '已完成'}},
                    {field: 'date', title: '完成时间', search: false},                    {field: 'create_time', title: '创建时间'},
                    {
                    	width: 250,
                    	title: '操作', 
                	...
                	res.data.forEach(function (item, index) {
                		...
                		tr.find(".laytable-cell-1-0-4").addClass('layuimini-table-url');
                        tr.find(".laytable-cell-1-0-4").attr("data-open",item.model+'/detail?id='+item.a_id);
                    });
                }
            });
