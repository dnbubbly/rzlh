        ...
        index: function () {
            ...
            ea.table.render({
                ...
                cols: [[
                    ...
                    {field: 'department.title', fieldAlias: 'department.id', minWidth: 80, title: '部门', search: 'selectTree', selectList: pidDepartmentList, searchOp: '='},
                    {field: 'is_leader', title: '是否负责人', width: 125, search: 'select', selectList: {0: '否', 1: '是'}, templet: ea.table.switch},
                    {field: 'name', minWidth: 80, title: '姓名'},
                    {field: 'username', minWidth: 80, title: '登录账户', search: false},
