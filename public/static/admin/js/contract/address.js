define(["jquery", "easy-admin"], function ($, ea) {
    ...
    var init = {
        ...
        index_url: 'contract.address/index',
        add_url: 'contract.address/add',
        edit_url: 'contract.address/edit',
        delete_url: 'contract.address/delete',
        export_url: 'contract.address/export',
        modify_url: 'contract.address/modify',
    };
